    ...
    <div class="page-wrapper compact-wrapper" id="pageWrapper"> 
      ...
      <div class="page-body-wrapper"> 
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                ...
                <div class="col-sm-6 col-12">
                  <a class="btn btn-primary float-end mx-2" id="btn_payments"><i class="fa-solid fa-plus"></i> Incluir Pagamento</a>
          ...
          <div class="container-fluid" style="display: none;" id="div_payments">
            <div class="edit-profile">
              <div class="row">
                <div class="col-xl-12">
                  <form id="pagamentos-form" class="card" method="post" enctype="multipart/form-data">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-responsive display" id="table-payments">
                          <thead>
                            <tr>
                              <th>NOME</th>
                              <th>CPF</th>
