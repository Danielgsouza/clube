            ...
            <div class="login-card login-dark">
              <div>
                ...
                <div class="login-main"> 
                  <form class="theme-form" id="new-password-form">
                    ...
                    <div class="form-group">
                      ...
                      <input class="form-control" type="password" name="login[password]" id="confirm-password" required="" placeholder="*********">
                    </div>
                    <div class="form-group mb-0 checkbox-checked">
                      <button class="btn btn-primary btn-block w-100 mt-3" type="submit">Enviar</button>
                    </div>
                    <p class="mt-4 mb-0">Não possui uma conta?<a class="ms-2" href="../sign-up/sign-up.php">Criar uma conta</a></p>
                  </form>
                </div>
              </div>
            </div>
