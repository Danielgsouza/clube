...
<html lang="pt-br">
  ...
  <body>
          ...
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                ...
                <div class="col-sm-6 col-12">
                  <a class="btn btn-secondary float-end" href="../dependents/dependents.php"><i class="fa-solid fa-arrow-left"></i> Voltar</a>
                </div>
              </div>
            </div>
          </div>
          <!-- Container-fluid starts-->
          <div class="container-fluid" id="div_dependents">
                          ...
                          <div class="row">
                              ...
                              <div class="col-sm-6 col-md-4">
                                <div class="mb-3">
                                  ...
                                  <input class="form-control" type="text" name="telefone" id="telefone" placeholder="11999999999" />
                                </div>
                              </div>
                              ...
                              <div class="col-sm-6 col-md-4">
                                <div class="mb-3">
                                  ...
                                  <select class="form-select" name="titular_id" id="titular_id" required>
                                  </select>
                                </div>
                              </div>
                          </div>
    ...
    <script src="./new-dependents.js"></script>
  </body>
</html>